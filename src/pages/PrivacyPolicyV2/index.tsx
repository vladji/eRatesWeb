    ...
    <Layout>
      <Section>
        <Content className={styles.content}>
          ...
          <p className={styles.mt1}>Last Updated May 02, 2023</p>
          <p className={styles.mt1}>
            Elvira Ospanova operates the website and the "eRates" mobile application
            (hereinafter referred to as the "Service"). This policy applies to all information that is collected or
            submitted through the "eRates" mobile application.
          </p>
          <p>
          ...
          <p className={styles.mt1}>
            eRates uses the collected data for various purposes:<br />
          ...
          <p className={styles.mt1}>
            If you are from the European Economic Area (EEA), eRates legal basis for collecting and using
          ...
          <p className={styles.mt1}>
            eRates may process your Personal Data because:<br />
          ...
          <p className={styles.mt1}>
            eRates will retain your Personal Data only for as long as is necessary for the purposes set out
          ...
          <p className={styles.mt1}>
            ...
            eRates will take all the steps reasonably necessary to ensure that your data is treated securely
          ...
          <p>
            If eRates is involved in a merger, acquisition or asset sale, your Personal Data may be
          ...
          <p className={styles.mt1}>eRates may disclose your Personal Data in the good faith belief that
            such action is necessary to:<br />
            - to comply with a legal obligation<br />
            - to protect and defend the rights or property of eRates<br />
